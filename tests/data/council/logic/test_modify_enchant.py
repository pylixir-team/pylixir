...
from pylixir.data.council.operation import SetEnchantIncreaseAmount, SetEnchantEffectCount
...
def test_set_effect_enchant_count(abundant_state: GameState) -> None:
    enchant_count = 2
    operation = SetEnchantEffectCount(
        ratio=0,
        value=(enchant_count,0),
        remain_turn=1
    )
